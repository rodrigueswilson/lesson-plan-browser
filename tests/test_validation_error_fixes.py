...
class TestEnumSerialization:
    ...
    def test_enum_conversion_helper(self):
    ...
    def test_check_for_enums_helper(self):
    ...
    def test_instructor_serialization_uses_json_mode(self, mock_instructor):
...
class TestErrorParsing:
    ...
    def test_parse_extra_field_error(self):
    ...
    def test_parse_structure_confusion(self):
...
class TestRetryPromptEnhancement:
    ...
    def test_retry_prompt_includes_structure_guidance(self):
    ...
    def test_retry_prompt_includes_enum_values(self):
    ...
    def test_retry_prompt_includes_pattern_guidance(self):
