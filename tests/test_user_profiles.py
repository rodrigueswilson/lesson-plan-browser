...
def test_create_user(temp_db):
    ...
    user_id = temp_db.create_user("John Doe", "john@example.com")
...
def test_get_user_by_name(temp_db):
    ...
    temp_db.create_user("Jane Smith", "jane@example.com")
...
def test_list_users(temp_db):
    ...
    temp_db.create_user("User 1", "user1@example.com")
    temp_db.create_user("User 2", "user2@example.com")
...
def test_update_user(temp_db):
    ...
    user_id = temp_db.create_user("Old Name", "old@example.com")
...
def test_delete_user(temp_db):
    ...
    user_id = temp_db.create_user("Delete Me", "delete@example.com")
...
def test_create_class_slot(temp_db):
    ...
    user_id = temp_db.create_user("Teacher", "teacher@example.com")
