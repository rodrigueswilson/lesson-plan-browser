"""
Batch ingest for Grade 2 Math corpus (Google Doc export + ingest_to_curriculum).

Requires Drive/Docs OAuth (tools/scraper/credentials/). Run from repo root:

  python tools/db/ingest_g2_math_corpus.py
  python tools/db/ingest_g2_math_corpus.py --unit-id Math_2_U4_1x8ll9eW
  python tools/db/ingest_g2_math_corpus.py --dry-run

Corpus definition: g2_math_corpus.G2_MATH_UNITS. After each unit, runs
