...
from . import fill_cell_cleanup as fill_cell_cleanup_module
...
def fill_cell(
    ...
    has_coordinate_hyperlinks = fill_cell_cleanup_module.remove_duplicate_coordinate_hyperlinks(
        cell, text, day_name, section_name, current_slot_number
    )
