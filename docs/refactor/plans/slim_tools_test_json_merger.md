# Refactor: tools/test_json_merger.py

## Current state

- **File:** `tools/test_json_merger.py` (455 non-empty lines, same metric as count_loc physical)
- **Branch:** `refactor/slim-tools-test-json-merger` (create from `master`)
...
1. Create branch from master: `git checkout master && git pull && git checkout -b refactor/slim-tools-test-json-merger`
