# Refactor: tools/diagnostics/analyze_objectives_layout.py

## Current state

- **File:** `tools/diagnostics/analyze_objectives_layout.py` (486 non-empty lines, same metric as count_loc physical)
- **Branch:** `refactor/slim-diagnostics-analyze-objectives-layout` (create from `master`)
...
1. Create branch from master: `git checkout master && git pull && git checkout -b refactor/slim-diagnostics-analyze-objectives-layout`
