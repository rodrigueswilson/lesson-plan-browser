# Refactor: tools/docx_renderer/table_cell/fill_cell.py

## Current state

- **File:** `tools/docx_renderer/table_cell/fill_cell.py` (503 non-empty lines)
- **Branch:** `refactor/slim-table-cell-fill-cell` (create from `master`)
...
1. Create branch from master: `git checkout master && git pull && git checkout -b refactor/slim-table-cell-fill-cell`
