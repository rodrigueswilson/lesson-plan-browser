...
| 329 | `backend/llm/validation.py` |
| 97 | `backend/llm/json_pre_validation.py` |
...
**Session 27 (six biggest files under 400 LOC):**

| Lines | File |
| -----:| ------ |
| 55 | `tools/test_json_merger.py` |
| 404 | `tools/test_json_merger_samples.py` |
| 344 | `backend/services/objectives_pdf_generator.py` |
| 136 | `backend/services/objectives_pdf_subject.py` |
| 394 | `backend/performance_tracker.py` |
| 76 | `backend/performance_tracker_export.py` |
| 34 | `backend/performance_tracker_sampling.py` |
| 387 | `tools/batch_processor_pkg/orchestrator.py` |
| 60 | `tools/batch_processor_pkg/orchestrator_parallel.py` |
| 345 | `tools/batch_processor_pkg/slot_flow_extract.py` |
| 89 | `tools/batch_processor_pkg/slot_flow_no_school.py` |
| 360 | `tools/batch_processor_pkg/combine_render/multi_slot.py` |
| 59 | `tools/batch_processor_pkg/combine_render/multi_slot_metadata.py` |

**Session 28 (six biggest files under 400 LOC):**

| Lines | File |
| -----:| ------ |
| 346 | `tools/validate_threshold_change_v2.py` |
| 69 | `tools/validate_threshold_link_analysis.py` |
| 329 | `backend/llm/validation.py` |
| 97 | `backend/llm/json_pre_validation.py` |
| 327 | `tools/docx_style_utils.py` |
| 98 | `tools/docx_style_file.py` |
| 331 | `backend/routers/plans.py` |
| 343 | `tools/diagnostics/slot_configuration_helper.py` |
| 79 | `tools/diagnostics/slot_configuration_output.py` |
| 329 | `tools/test_json_merger_samples.py` |
| 82 | `tools/test_json_merger_sample_days.py` |
...
- **test_json_merger under 400 LOC (Session 27)** — Branch `refactor/slim-tools-test-json-merger`. create_sample_slot -> tools/test_json_merger_samples.py; test_json_merger.py ~55 lines.
- **objectives_pdf_generator under 400 LOC (Session 27)** — Branch `refactor/slim-services-objectives-pdf-generator`. extract_subject_from_unit_lesson -> backend/services/objectives_pdf_subject.py; objectives_pdf_generator.py ~344 lines.
- **performance_tracker under 400 LOC (Session 27)** — Branch `refactor/slim-backend-performance-tracker`. CSV export, sampling, get_most_common_model -> performance_tracker_export.py, performance_tracker_sampling.py; performance_tracker.py ~394 lines.
- **orchestrator under 400 LOC (Session 27)** — Branch `refactor/slim-batch-processor-pkg-orchestrator`. _process_slots_parallel_llm -> orchestrator_parallel.py; orchestrator.py ~387 lines.
- **slot_flow_extract under 400 LOC (Session 27)** — Branch `refactor/slim-batch-processor-pkg-slot-flow-extract`. build_no_school_day_json, build_no_school_week_json -> slot_flow_no_school.py; slot_flow_extract.py ~345 lines.
- **combine_render/multi_slot under 400 LOC (Session 27)** — Branch `refactor/slim-combine-render-multi-slot`. apply_slot_metadata_to_lesson -> multi_slot_metadata.py; multi_slot.py ~360 lines.
- **validate_threshold_change_v2 under 400 LOC (Session 28)** — Branch `refactor/slim-tools-validate-threshold-change-v2`. extract_output_links_with_urls, categorize_links -> tools/validate_threshold_link_analysis.py; validate_threshold_change_v2.py ~346 lines.
- **backend/llm/validation under 400 LOC (Session 28)** — Branch `refactor/slim-llm-validation`. pre_validate_json -> backend/llm/json_pre_validation.py; validation.py ~329 lines.
- **docx_style_utils under 400 LOC (Session 28)** — Branch `refactor/slim-tools-docx-style-utils`. normalize_styles_via_file -> tools/docx_style_file.py; docx_style_utils.py ~327 lines.
- **backend/routers/plans under 400 LOC (Session 28)** — Branch `refactor/slim-routers-plans`. Debug print block removed from get_plan_detail; plans.py ~331 lines.
- **slot_configuration_helper under 400 LOC (Session 28)** — Branch `refactor/slim-diagnostics-slot-configuration-helper`. print_suggestions, print_validation -> tools/diagnostics/slot_configuration_output.py; slot_configuration_helper.py ~343 lines.
- **test_json_merger_samples under 400 LOC (Session 28)** — Branch `refactor/slim-tools-test-json-merger-samples`. build_sample_friday -> tools/test_json_merger_sample_days.py; test_json_merger_samples.py ~329 lines.
