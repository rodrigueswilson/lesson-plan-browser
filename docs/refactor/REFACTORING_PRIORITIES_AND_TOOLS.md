...
**Last updated:** 2026-02-22 (Session 20 slot_flow split on branch refactor/slot-flow-split; slot_flow_resolve, slot_flow_extract, slot_flow_transform; slot_flow.py slim orchestrator.)
...
**Database (Session 7, post package extraction):**

| Lines | File |
| -----:| ------ |
| 480 | `backend/database/metrics.py` |
...
**Users router (Session 15, post split):**

| Lines | File |
| -----:| ------ |
| 483 | `backend/routers/users.py` |
