...
**Last updated:** 2026-02-22 (Session 22 week_flow split on branch refactor/week-flow-split; week_flow_load, week_flow_existing, week_flow_parallel, week_flow_sequential, week_flow_merge_render; week_flow.py slim orchestrator.)
