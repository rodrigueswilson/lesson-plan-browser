...
**Last updated:** 2026-02-22 (Session 23 llm-service-split on branch refactor/llm-service-split; api_key, token_limits, transform_runner in backend/llm/; llm_service.py slim facade.)
...
### 0.5 Line counts (backend LLM, post–Session 23; docx_renderer post–Session 5)
